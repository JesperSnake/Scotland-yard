...
mrx_start_positions = [35, 45, 51, 71, 78, 104, 106, 127, 132, 146, 166, 170, 172]
...
board_graph = {
    ...
    11: {'taxi': [3, 10, 22]},
    12: {'taxi': [3, 23]},
    13: {'taxi': [4, 14, 23, 24], 'bus': [14, 23, 52], 'metro': [46, 67, 89]},
    14: {'taxi': [13, 15, 25], 'bus': [13, 15]},
    ...
    46: {'taxi': [33, 45, 47, 61], 'bus': [1, 34, 58, 78], 'metro': [1, 13, 74, 79]},
    47: {'taxi': [34, 46, 62]},
    48: {'taxi': [34, 35, 62, 63]},
    49: {'taxi': [36, 50, 66]},
    50: {'taxi': [37, 38, 49]},
    ...
    66: {'taxi': [49, 65, 67, 82]},
    67: {'taxi': [51, 66, 68, 84], 'bus': [23, 52, 65, 82, 102], 'metro': [13, 79, 89, 111]},
    68: {'taxi': [51, 67, 69, 85]},
    69: {'taxi': [52, 53, 68, 86]},
    70: {'taxi': [54, 71, 87]},
    71: {'taxi': [55, 70, 72, 89]},
    ...
    73: {'taxi': [57, 74, 92]},
    74: {'taxi': [58, 73, 75, 92], 'bus': [58, 94], 'metro': [46]},
    75: {'taxi': [58, 59, 74, 94]},
    76: {'taxi': [59, 60, 61, 77]},
    77: {'taxi': [76, 78, 95, 96], 'bus': [58, 78, 94, 124]},
    78: {'taxi': [61, 77, 79, 97], 'bus': [46, 77, 79]},
    79: {'taxi': [62, 63, 78, 98], 'bus': [63, 78], 'metro': [46, 67, 93, 111]},
    80: {'taxi': [63, 99, 100]},
    81: {'taxi': [64, 82, 100]},
    ...
    88: {'taxi': [87, 89, 117]},
    89: {'taxi': [71, 88, 105], 'bus': [55, 105], 'metro': [13, 67, 128, 140]},
    90: {'taxi': [72, 91, 105]},
    91: {'taxi': [56, 72, 90, 105, 107]},
    92: {'taxi': [73, 74, 93]},
    93: {'taxi': [92, 94], 'bus': [94], 'metro': [79]},
    ...
    108: {'taxi': [105, 117, 119], 'bus': [105, 116, 135], 'water': [115]},
    109: {'taxi': [96, 97, 110, 124]},
    110: {'taxi': [98, 99, 109, 111]},
    111: {'taxi': [110, 112, 124], 'bus': [100, 124], 'metro': [67, 79, 153, 163]},
    112: {'taxi': [99, 100, 111, 125]},
    113: {'taxi': [100, 114, 125]},
    114: {'taxi': [101, 113, 115, 126, 131, 132]},
    115: {'taxi': [102, 114, 126, 127], 'water': [108, 157]},
    ...
    128: {'taxi': [142, 143, 160, 172, 188], 'bus': [135, 142, 161, 187, 199], 'metro': [89, 140, 185]},
    ...
    140: {'taxi': [126, 132, 133, 139, 154, 156], 'bus': [82, 133, 154, 156], 'metro': [89, 128, 153]},
    141: {'taxi': [133, 134, 142, 158]},
    142: {'taxi': [118, 128, 129, 134, 141, 143, 158], 'bus': [116, 128, 157]},
    ...
    194: {'taxi': [192, 193, 195], 'water': [157]},
